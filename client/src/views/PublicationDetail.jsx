      ...
      <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div>
          ...
          {loading ? (
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: 13, padding: '20px 0', textAlign: 'center' }}>No articles found for this issue.</div>
          ) : (
        ...
        <div>
          ...
          {loading ? (
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: 13 }}>No articles found for this issue.</div>
          ) : (
